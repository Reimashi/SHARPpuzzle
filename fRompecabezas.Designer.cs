namespace Rompecabezas
{
    partial class fRompecabezas
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.botones = new System.Windows.Forms.Button[16];
            for (int i = 0; i <= 15; i++)
            {
                this.botones[i] = new System.Windows.Forms.Button();
            }
            ...
            this.toolStripStatusLabel1.Text = "Movimientos: 0";
            // 
            // menuStrip1
            // 
            ...
            this.nuevoJuegoToolStripMenuItem.Click += new System.EventHandler(this.NuevoJuego_Click);
            // 
            ...
            this.toolStripComboBox1.SelectedIndexChanged += new System.EventHandler(this.SelectorImagen_Click);
            // 
            // toolStripSeparator1
            // 
            ...
            this.toolStripMenuItem1.Text = "Personalizar Imagen";
            this.toolStripMenuItem1.Click += new System.EventHandler(this.PersonalizarImagen_Click);
            // 
            ...
            this.button1.Click += new System.EventHandler(this.NuevoJuego_Click);
            // 
            // flowLayoutPanel1
            // 
            ...
            for (int i = 0; i <= 15; i++)
            {
                this.flowLayoutPanel1.Controls.Add(this.botones[i]);
            }
            this.flowLayoutPanel1.Location = new System.Drawing.Point(12, 56);
            this.flowLayoutPanel1.Name = "flowLayoutPanel1";
            this.flowLayoutPanel1.Size = new System.Drawing.Size(510, 509);
            ...
            {
                this.botones[i].Margin = new System.Windows.Forms.Padding(1);
                this.botones[i].Name = "boton_" + i.ToString();
                this.botones[i].Size = new System.Drawing.Size(125, 125);
                this.botones[i].TabIndex = i;
                this.botones[i].UseVisualStyleBackColor = true;
                this.botones[i].Click += new System.EventHandler(this.Tablero_Click);
            }
            // 
            // pictureBox1
            // 
            this.pictureBox1.Location = new System.Drawing.Point(652, 147);
